const CACHE='samara-care-erp-v3.1.0';
const ASSETS=['./','./index.html','./styles.css?v=3.1.0','./app.js?v=3.1.0','./config.js?v=3.1.0','./manifest.webmanifest?v=3.1.0','./icons/icon-192.png','./icons/icon-512.png'];
