const CACHE='samara-care-erp-v2.4.0';
const ASSETS=['./','./index.html','./styles.css?v=210','./app.js?v=210','./config.js?v=210','./manifest.webmanifest?v=210','./icons/icon-192.png','./icons/icon-512.png'];
